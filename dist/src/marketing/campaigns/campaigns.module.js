...
exports.CampaignsModule = CampaignsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([Campaign_1.Campaign, CampaignFunnel_1.CampaignFunnel, CampaignSend_1.CampaignSend])],
        controllers: [campaigns_controller_1.CampaignsController],
        providers: [campaigns_service_1.CampaignsService, email_service_1.EmailService],
