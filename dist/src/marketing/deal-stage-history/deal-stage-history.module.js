...
const DealStageHistory_1 = require("../../marketing/deal-stage-history/DealStageHistory");
...
exports.DealStageHistoryModule = DealStageHistoryModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([DealStageHistory_1.DealStageHistory])],
