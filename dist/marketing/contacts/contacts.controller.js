...
let ContactsController = class ContactsController {
    ...
    async importLeads(file) {
        if (!file)
            throw new common_1.BadRequestException("Se requiere un archivo Excel o CSV.");
        return this.service.importContacts(file.buffer);
    }
    findAll(type, q, status, sourceId, page, limit) {
...
], ContactsController.prototype, "importLeads", null);
__decorate([
    (0, common_1.Get)(),
...
exports.ContactsController = ContactsController = __decorate([
    (0, common_1.Controller)("mk/contacts"),
