...
export declare class DealsController {
    ...
    create(dto: CreateDealDto, req: any): Promise<import("./Deal").Deal>;
    update(id: string, dto: UpdateDealDto): Promise<import("./Deal").Deal>;
    changeStage(id: string, toStageId: string, req: any): Promise<import("./Deal").Deal | null>;
    moveStage(id: string, body: {
        to_stage_id: number;
    }, req: any): Promise<import("./Deal").Deal | null>;
}
